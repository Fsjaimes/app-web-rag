    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        <li class="menu-title">
          ...
          <a class="nav-link menu-link" href="#sidebarDocumentos" data-bs-toggle="collapse" role="button"
            aria-expanded="false" aria-controls="sidebarDocumentos">
            <i class="ri-file-list-line"></i>
            <span>Documentación</span>
          </a>
          <div class="collapse menu-dropdown" id="sidebarDocumentos">
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <Link href="/documentacion/api-cartera" class="nav-link custom-abc">
                  API Cartera
                </Link>
              </li>
              <li class="nav-item">
                <Link href="/documentacion/api-comprobantes" class="nav-link custom-abc">
                  API Comprobantes
                </Link>
              </li>
            </ul>

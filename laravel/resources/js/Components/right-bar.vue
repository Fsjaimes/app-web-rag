<script>
// localStorage.setItem("rightbar_isopen", false); // Solo para customizer (comentado)
import { layoutMethods, layoutComputed } from "@/state/helpers";
// import simplebar from "simplebar-vue"; // Solo para customizer offcanvas (comentado)
/**
...
export default {
  data() {
    return {
      // show: false,           // Solo para customizer offcanvas (comentado)
      // showGradients: false, // Solo para collapse gradientes sidebar (comentado)
      // resetLayoutMode: {},  // No usado
    };
  },
  // beforeCreate() {
  //   localStorage.setItem("resetValue", JSON.stringify(this.$store.state.layout)); // Solo para resetLayout (comentado)
  // },
  methods: {
    ...layoutMethods,
    // click() {
    //   this.show = !this.show; // Solo para customizer (comentado)
    // },
    topFunction() {
    ...
    // resetLayout() - Solo para botón Reset del customizer (comentado)
    // resetLayout() {
    ...
    // gradiantColor() - Solo para customizer sidebar color (comentado)
    // gradiantColor() {
    //   this.changeSidebarColor({ sidebarColor: "gradient" })
    // },

    // onSideBarColorClick() - Solo para customizer sidebar color (comentado)
  ...
  mounted() {
    ...
    // Solo para customizer collapse gradientes (comentado)
  ...
  computed: {
    ...
    layoutType: {
      ...
      // set solo para customizer (comentado)
      // set(layout) {
    ...
    preloader: {
      ...
      // set solo para customizer (comentado)
      // set(preloader) {
      //   return this.changePreloader({ preloader: preloader });
      // },
    },
    mode: {
      get() {
    ...
    sidebarSize: {
      ...
      // set solo para customizer (comentado)
      // set(type) {
      //   return this.changeSidebarSize({ sidebarSize: type });
      // },
    },
    layoutWidth: {
      get() {
    ...
    position: {
      ...
      // set solo para customizer (comentado)
      // set(position) {
      //   return this.changePosition({ position: position });
      // },
    },
    topbar: {
      get() {
    ...
    sidebarView: {
      ...
      // set solo para customizer (comentado)
      // set(sidebarView) {
      //   return this.changeSidebarView({ sidebarView: sidebarView });
      // },
    },
    sidebarColor: {
      get() {
      ...
      // set solo para customizer (comentado)
      // set(sidebarColor) {
      //   return this.changeSidebarColor({ sidebarColor: sidebarColor });
      // },
    },
    sidebarImage: {
      get() {
  ...
  watch: {
    // show - solo para customizer offcanvas (comentado)
    // show: {
    //   immediate: true,
    //   deep: true,
  ...
  // components: { simplebar } // Solo para customizer offcanvas (comentado)
};

...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified', 'tenant'])->group(function () {

    Route::controller(VelzonRoutesController::class)->group(function () {

        // Inicio: panel principal del sistema (módulo Dashboard). Demo Velzon bajo ruta explícita.
        Route::get('/', fn () => redirect()->route('dashboard.index'))->name('dashboard');
        Route::get('/plantilla/velzon-ecommerce', 'dashboard')->name('velzon.dashboard');
